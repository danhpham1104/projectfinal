...
public class EgyptianPyramidsAppExample {
  ...
  public EgyptianPyramidsAppExample() {
    ...
    String pharaohFile =
      "/Users/redbean/Downloads/egyptianExample 3/pharaoh.json";
    ...
    // read pyramids
    String pyramidFile =
      "/Users/redbean/Downloads/egyptianExample 3/pyramid.json";
  ...
  private void printAllPyramid(){
    for (int j = 0; j < pyramidArray.length; j++){
      printMenuLine();
      pyramidArray[j].print();
      printMenuLine();
  ...
  public static void printMenu() {
    ...
    printMenuCommand('2', "Display a specfic Egyptian pharaoh");
